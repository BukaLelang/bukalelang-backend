define({ "api": [
  ...
  {
    "type": "post",
    "url": "/auctions/checkout",
    "title": "checkout product after win the auction",
    "group": "Auction",
    "parameter": {
      "examples": [
        {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "userId",
            "description": "<p>userId of user the winner</p>"
          },
          {
            "group": "Parameter",
            "type": "Integer",
          ...
          },
          {
            ...
            "description": "<p>example JNE REG or JNE YES, not only jne</p>"
          },
          {
            "group": "Parameter",
            "type": "Integer",
    ...
    "filename": "./routes/auctions.js",
    "groupTitle": "Auction",
    "name": "PostAuctionsCheckout",
    "sampleRequest": [
      {
        "url": "http://localhost:3000/auctions/checkout"
      }
    ]
  },
  {
  ...
  {
    "type": "get",
    "url": "/users/:id/auctions-won",
    "title": "get auctions that this user won",
    "group": "Users",
    "success": {
      "fields": {
        "Success 200": [
    ...
    "filename": "./routes/users.js",
    "groupTitle": "Users",
    "name": "GetUsersIdAuctionsWon",
    "sampleRequest": [
      {
        "url": "http://localhost:3000/users/:id/auctions-won"
      }
    ]
  },
  {
  ...
  {
    "type": "get",
    "url": "/users/:id/my-auctions",
    "title": "get auctions created by this user",
    "group": "Users",
    "success": {
      "fields": {
        "Success 200": [
    ...
    "filename": "./routes/users.js",
    "groupTitle": "Users",
    "name": "GetUsersIdMyAuctions",
    "sampleRequest": [
      {
        "url": "http://localhost:3000/users/:id/my-auctions"
      }
    ]
  },
  {
